...
public class WorkListGenerationBatch extends AbstractBatchProcess {
	public static final String ROOT = "root";
  
  public WorkListGenerationBatch() {
    ...
    try {
			return new WorkListService().generateWorkLists(getEffectiveDate(), root, new HashMap());
